...
from .models import DownloadTask, ProgressInfo, TaskConfig, GlobalConfig, ProxyConfig
...
class FileSystemValidator:
    ...
    @staticmethod
    def is_valid_path(path: Union[str, Path], must_exist: bool = False) -> bool:
    ...
    @staticmethod
    def get_available_space(path: Union[str, Path]) -> Optional[int]:
...
def get_engine_for_url(url: str) -> Optional[str]:
