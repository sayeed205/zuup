...
def test_download_task_model():
    ...
    try:
        ...
        print(f"  ✓ Valid remote .torrent file task created with ID: {torrent_file_task.id}")
    except Exception as e:
    ...
    try:
        ...
        print(f"  ✓ Valid local .torrent file task created with ID: {local_torrent_task.id}")
    except Exception as e:
...
def test_url_validator():
    ...
    test_urls = [
        ...
        ("magnet:?xt=urn:btih:1234567890abcdef1234567890abcdef12345678", True, "torrent"),
