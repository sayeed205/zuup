...
def main() -> None:
    ...
    parser.add_argument(
        "--check-deps", action="store_true", help="Check development dependencies"
    )
    parser.add_argument(
        "--type-check", action="store_true", help="Run detailed type checking"
    )
    parser.add_argument("--lint", action="store_true", help="Run detailed linting")
    parser.add_argument(
        "--fix", action="store_true", help="Fix code issues automatically"
    )
    ...
    parser.add_argument(
        "--validate", action="store_true", help="Validate project structure"
    )
